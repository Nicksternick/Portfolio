    ...
    {        
        ...
        xhrKanji.onloadend = (e) =>
        {
            ...
            // if there was a 404 error, print an error message to the HTML
            if (xhrKanji.status == 404)
            {
                kanjiSymbol.innerHTML = "";
                kanjiText.innerHTML = `<div class='kanjiSymbol'>Invalid Search, Please Try Again</div>`;
            }
        }
